...
// Utility functions
export function getProductTypeTemplate(
  typeId: string
): ProductTypeTemplate | undefined {
  ...
  return Object.values(PRODUCT_TYPE_TEMPLATES).find(
...
export function validateProductTypeTemplate(
...
export function getTemplateByCategory(category: string): ProductTypeTemplate[] {
  return Object.values(PRODUCT_TYPE_TEMPLATES).filter(
    (template) => template.category === category
  );
}

export function getRequiredVariantAxes(
  template: ProductTypeTemplate
): VariantAxis[] {
