...
export const orders = sqliteTable("orders", {
  ...
  paymentMethod: text("payment_method").default("bank_transfer"), // bank_transfer, credit_card, virtual_account, apple_pay, google_pay
  ...
  // GOMYPAY integration fields
  gomypayOrderId: text("gomypay_order_id"), // GOMYPAY 系統訂單編號
  paymentGateway: text("payment_gateway").default("manual"), // gomypay, manual
  paymentDetails: text("payment_details", { mode: "json" }), // Gateway response data (avCode, etc.)
  paymentInitiatedAt: integer("payment_initiated_at", { mode: "timestamp" }),
...
export const appointments = sqliteTable("appointments", {
  ...
  followUpRequired: integer("follow_up_required", { mode: "boolean" }).default(
    false
  ), // 是否需要後續追蹤
...
export const reservations = sqliteTable("reservations", {
  ...
  verificationPending: integer("verification_pending", {
    mode: "boolean",
  }).default(true),
...
export const customerProfiles = sqliteTable("customer_profiles", {
  ...
  // Product Preferences
  favoriteCategories: text("favorite_categories", { mode: "json" }).default(
    "[]"
  ), // 偏好產品分類
...
export const customerTagAssignments = sqliteTable("customer_tag_assignments", {
  id: text("id")
    .primaryKey()
    .$defaultFn(() => createId()),
  customerProfileId: text("customer_profile_id").references(
    () => customerProfiles.id,
    {
      onDelete: "cascade",
    }
  ),
  customerTagId: text("customer_tag_id").references(() => customerTags.id, {
    onDelete: "cascade",
  }),
...
export const userSecurity = sqliteTable("user_security", {
  ...
  // Privacy Settings
  allowDataCollection: integer("allow_data_collection", {
    mode: "boolean",
  }).default(true),
  allowMarketing: integer("allow_marketing", { mode: "boolean" }).default(true),
  allowSmsMarketing: integer("allow_sms_marketing", {
    mode: "boolean",
  }).default(false),
...
export const customerNotificationPreferences = sqliteTable(
  "customer_notification_preferences",
  {
    ...
    // Email Notifications
    emailOrderUpdates: integer("email_order_updates", {
      mode: "boolean",
    }).default(true),
    emailAppointmentReminders: integer("email_appointment_reminders", {
      mode: "boolean",
    }).default(true),
    emailNewsletters: integer("email_newsletters", { mode: "boolean" }).default(
      true
    ),
    emailPromotions: integer("email_promotions", { mode: "boolean" }).default(
      true
    ),
    emailPriceAlerts: integer("email_price_alerts", {
      mode: "boolean",
    }).default(true),
    ...
    // SMS Notifications
    smsOrderUpdates: integer("sms_order_updates", { mode: "boolean" }).default(
      false
    ),
    smsAppointmentReminders: integer("sms_appointment_reminders", {
      mode: "boolean",
    }).default(true),
    smsPromotions: integer("sms_promotions", { mode: "boolean" }).default(
      false
    ),
    smsDeliveryUpdates: integer("sms_delivery_updates", {
      mode: "boolean",
    }).default(true),

    // Push Notifications (for future mobile app)
    pushOrderUpdates: integer("push_order_updates", {
      mode: "boolean",
    }).default(true),
    pushAppointmentReminders: integer("push_appointment_reminders", {
      mode: "boolean",
    }).default(true),
    pushPromotions: integer("push_promotions", { mode: "boolean" }).default(
      false
    ),
