      ...
      <div className="max-w-lg mx-auto space-y-6 text-left">
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <div className="space-y-1">
            <p><span className="text-gray-600">姓名：</span>{appointmentData.name}</p>
            <p><span className="text-gray-600">電話：</span>{appointmentData.phone}</p>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <p><span className="text-gray-600">日期：</span>{formatDate(appointmentData.preferredDate)}</p>
          <p><span className="text-gray-600">時段：</span>{timeSlotLabels[appointmentData.preferredTime as keyof typeof timeSlotLabels]}</p>
        </div>
